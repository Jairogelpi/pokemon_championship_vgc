...
Antes de READY y de VERIFIED, revisar [DETAILED_COVERAGE](../../docs/quality/DETAILED_COVERAGE.md): §0 (REQ-S00-xx), §46 (REQ-S46-xx), §48 (REQ-S48-xx), §53 (REQ-S53-xx), §58 (REQ-S58-xx), §59 (REQ-S59-xx), §61 (REQ-S61-xx). Asignar todos los subrequisitos y miembros de sus enumeraciones a aceptación/tests; no basta con los tres criterios iniciales resumidos. La fuente completa sigue siendo referencia para ejemplos y casos límite.
